...
class ExperimentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post experiments_url, params: { experiment: { language: @experiment.language, primary: @experiment.primary, repo: @experiment.repo, user: @experiment.user } }
    end
  ...
  test "should update experiment" do
    patch experiment_url(@experiment), params: { experiment: { language: @experiment.language, primary: @experiment.primary, repo: @experiment.repo, user: @experiment.user } }
